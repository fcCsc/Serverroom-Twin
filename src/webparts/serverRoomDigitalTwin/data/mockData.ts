...
export const mockDevices: IDevice[] = [
  ...
  { DeviceKey: 'dev-sw-002', RackKey: 'rack-a01', Title: 'SW-DEMO-RIGHT', DeviceType: 'Switch', UPosition: 40, UHeight: 1, MountWidth: 'Half', HorizontalSlot: 2, RackSide: 'Front', ModelAssetKey: 'switch', Owner: 'Network Team', Environment: 'Demo', Notes: 'Half-width dummy switch mounted at U40, right slot.', Manufacturer: 'Demo Networks', Model: 'DN-SW-24', IPAddress: '192.0.2.12', VLAN: 'DEMO-110', SerialNumber: 'DEMO-SW-002', WarrantyExpiry: '2027-06-30', MaintenanceResponsible: 'Network Team' },
  ...
  { DeviceKey: 'dev-backup-001', RackKey: 'rack-a02', Title: 'BACKUP-DEMO-001', DeviceType: 'Backup', UPosition: 30, UHeight: 2, MountWidth: 'Full', HorizontalSlot: 1, RackSide: 'Front', ModelAssetKey: 'backup', Owner: 'Infrastructure Team', Environment: 'Shared', Notes: 'Two-unit backup system demonstrating repeated GLB placement.', Manufacturer: 'Demo Backup', Model: 'DBK-2U', IPAddress: '192.0.2.45', VLAN: 'DEMO-450', SerialNumber: 'DEMO-BKP-001', WarrantyExpiry: '2028-08-31', MaintenanceResponsible: 'Infrastructure Team' },
...
export const mockModelAssets: IModelAsset[] = [
  ...
  { ModelAssetKey: 'backup', Title: 'Full-width backup panel', FileName: 'Panel-normal.glb', LibraryRelativePath: `${defaultAssetLibraryPath}/Panel-normal.glb`, DefaultForDeviceType: 'Backup', ScaleX: 1, ScaleY: 1, ScaleZ: 1, RotationOffset: 0 }
];
...
export const mockDeviceTypeAssetMappings: IDeviceTypeAssetMapping[] = [
  ...
  { DeviceType: 'Backup', ModelAssetKey: 'backup', DefaultMountWidth: 'Full', DefaultUHeight: 2 }
];
