...
const renderFatalFallback = (error?: unknown): void => {
  ...
  root.innerHTML = `<section class="previewFallback"><strong>Serverroom Twin Preview</strong><h1>Dashboard konnte nicht gestartet werden</h1><p>${message}</p><p>Bitte lade die Seite neu oder öffne den Build ohne Browser-Erweiterungen. Die Seite zeigt diese Meldung statt schwarz zu bleiben.</p></section>`;
};
